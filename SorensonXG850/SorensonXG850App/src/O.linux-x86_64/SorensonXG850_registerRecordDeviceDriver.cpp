...
/* Generated from ../O.Common/SorensonXG850.dbd */
...
static const char * const deviceSupportNames[104] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[104] = {
...
int SorensonXG850_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/SorensonXG850";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"SorensonXG850_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    SorensonXG850_registerRecordDeviceDriver(*iocshPpdbbase);
}
