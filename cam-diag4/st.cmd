...
epicsEnvSet("PREFIX", "XF:23ID2-BI{Diag:4-Cam:1}")
...
prosilicaConfig("$(PORT)", "10.23.1.37", 50, 0, 0, 0, 10)
...
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=17000000,NDARRAY_PORT=$(PORT)")
...
dbl > /cf-update/xf23id2-ioc1.cam-diag4.dbl
