...
/* Generated from ../O.Common/stanfordSR570.dbd */
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"stanfordSR570_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    stanfordSR570_registerRecordDeviceDriver(*iocshPpdbbase);
}
