...
/* Generated from ../O.Common/lakeshore336.dbd */
...
int lakeshore336_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/es-tctrl1";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"lakeshore336_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    lakeshore336_registerRecordDeviceDriver(*iocshPpdbbase);
}
