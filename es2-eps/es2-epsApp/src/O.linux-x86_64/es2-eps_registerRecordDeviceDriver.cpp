...
/* Generated from ../O.Common/es2-eps.dbd */
...
int es2_eps_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/es2-eps";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"es2_eps_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    es2_eps_registerRecordDeviceDriver(*iocshPpdbbase);
}
