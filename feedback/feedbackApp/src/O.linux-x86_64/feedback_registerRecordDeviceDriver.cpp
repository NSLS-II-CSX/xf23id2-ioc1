...
/* Generated from ../O.Common/feedback.dbd */
...
static const char * const deviceSupportNames[102] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[102] = {
...
int feedback_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/feedback";
    ...
    registerDevices(pbase, 102, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"feedback_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    feedback_registerRecordDeviceDriver(*iocshPpdbbase);
}
