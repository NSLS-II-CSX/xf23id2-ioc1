...
static const char * const recordTypeNames[40] = {
    "aai",
    "aao",
    "ai",
    "ao",
...
static const recordTypeLocation rtl[40] = {
...
epicsShareExtern void (*pvar_func_register_func_interp1d)(void);
...
{
    const char *bldTop = "/epics/iocs/mc02";
    ...
    registerRecordTypes(pbase, 40, recordTypeNames, rtl);
    ...
    (*pvar_func_register_func_interp1d)();
