...
pmacAsynIPConfigure("P0","xf23id2-mc10:1025")
...
pmacCreateController("motor","P0",0,3,100,1000)
...
dbLoadRecords("db/asynComm.db","P=XF:23ID2-CT{MC:10},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:23ID2-CT,PMAC=MC:10,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:23ID2-CT{IOC:MC10}")
...
dbl > "/cf-update/xf23id2-ioc1.mc10.dbl"
