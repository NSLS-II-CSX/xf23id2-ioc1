...
pmacAsynIPConfigure("P0","xf23id2-mc11:1025")
...
pmacCreateController("motor","P0",0,4,100,1000)
...
dbLoadRecords("db/asynComm.db","P=XF:23ID2-CT{MC:11},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:23ID2-CT,PMAC=MC:11,VERSION=1,PLC=5,PORT=P0,NAXES=1")
dbLoadTemplate("db/pmac_asyn_motor.substitutions")
dbLoadTemplate("db/autohome.substitutions")
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:23ID2-CT{IOC:MC11}")
...
dbl > "/cf-update/xf23id2-ioc1.mc11.dbl"
