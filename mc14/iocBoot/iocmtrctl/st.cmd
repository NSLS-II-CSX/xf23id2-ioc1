...
#pmacAsynIPConfigure("$(TP_PORT)", "xf23id2-mc14:1025")
pmacAsynIPConfigure("$(TP_PORT)", "10.23.2.115:1025")
...
dbLoadRecords("$(TOP)/iocBoot/$(IOC)/read_var.db","P=$(P){IOC-$(MC)},R=M1Enc,PORT=$(TP_PORT),ADDR=0,VAR=M8000,SCALE=1.5625e-4,OFFSET=0.0")
dbLoadRecords("$(TOP)/iocBoot/$(IOC)/read_var.db","P=$(P){IOC-$(MC)},R=M2Enc,PORT=$(TP_PORT),ADDR=0,VAR=M8001,SCALE=1.5625e-4,OFFSET=0.0")
dbLoadRecords("$(TOP)/iocBoot/$(IOC)/read_var.db","P=$(P){IOC-$(MC)},R=M3Enc,PORT=$(TP_PORT),ADDR=0,VAR=M8002,SCALE=1.5625e-4,OFFSET=0.0")
