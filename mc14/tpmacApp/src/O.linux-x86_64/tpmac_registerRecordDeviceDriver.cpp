...
epicsShareExtern drvet *pvar_drvet_pmacAsynCoord;
...
epicsShareExtern void (*pvar_func_pmacAsynCoordRegister)(void);
...
{
    const char *bldTop = "/epics/iocs/mc14";
    ...
    (*pvar_func_pmacAsynCoordRegister)();
