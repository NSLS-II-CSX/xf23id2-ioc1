...
/* Generated from ../O.Common/Hexapod.dbd */
...
int Hexapod_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/op-m3b/6POD";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"Hexapod_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    Hexapod_registerRecordDeviceDriver(*iocshPpdbbase);
}
