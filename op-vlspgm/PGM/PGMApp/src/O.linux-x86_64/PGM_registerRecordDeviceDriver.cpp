...
/* Generated from ../O.Common/PGM.dbd */
...
static const char * const deviceSupportNames[105] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[105] = {
...
int PGM_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/op-vlspgm/PGM";
    ...
    registerDevices(pbase, 105, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PGM_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PGM_registerRecordDeviceDriver(*iocshPpdbbase);
}
