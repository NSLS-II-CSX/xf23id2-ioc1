...
/* Generated from ../O.Common/SAI.dbd */
...
int SAI_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/op-vlspgm/SAI";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"SAI_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    SAI_registerRecordDeviceDriver(*iocshPpdbbase);
}
